...
Agent CLIs are optional adapters. They may read the protocol and prepare proposals, but no provider, cloud service, API key, database server, or network connection is required by the core.
