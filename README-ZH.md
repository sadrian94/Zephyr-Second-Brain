...
>
> 📖 閱讀完整的 **[Zephyr 的哲學與定位](./docs/philosophy-and-positioning-zh.md)** 說明文件，深入瞭解我們的「心流優先」設計與按需調度架構。
...
- 💡 **[Zephyr 的哲學與定位](./docs/philosophy-and-positioning-zh.md)**：心流優先的設計理念。
- ⚙️ **[技術架構說明書](./docs/architecture-zh.md)**：底層腳本交互與 `index.json` 機制。
- 🎯 **[專案管理指南](./docs/project-management-zh.md)**：如何建立並自動化專案的生命週期。
